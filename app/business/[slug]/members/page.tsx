    ...
    <div className="space-y-5">
      ...
      >
        ...
        <p className="mt-1 text-sm" style={{ color: "var(--sage)" }}>
          Only people listed here can see this business - nobody else, even if
          signed in.
        </p>
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 space-y-2">
              {pendingInvites.map((inv) => (
                <div
                  key={inv.id}
                  className="flex items-center justify-between rounded-[var(--radius-md)] border border-dashed p-3"
                  style={{ borderColor: "var(--line)" }}
                >
      ...
      {canAdd ? (
        ...
        >
          ...
          >
            Add your accountant or anyone else who should see this business. If
            they don't have an account yet, they'll get access automatically the
            moment they sign up with this email - no invite email is sent yet,
            this just reserves their access.
          </p>
