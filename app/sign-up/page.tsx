  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bone)" }}>
      <main className="mx-auto max-w-sm px-5 py-20 sm:px-8">
        ...
        <h1
          className="font-display mt-8 text-2xl font-bold"
          style={{ color: "var(--ink)" }}
        >
          Create your account
        </h1>
        ...
        <button
          ...
          className="font-display mt-6 flex w-full items-center justify-center gap-2.5 rounded-[var(--radius-md)] border px-5 py-3 text-sm font-bold transition hover:opacity-80"
          style={{
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="font-display flex w-full items-center justify-center gap-2.5 rounded-[var(--radius-md)] px-5 py-3 text-sm font-bold uppercase tracking-[0.06em] text-white transition disabled:cursor-not-allowed disabled:opacity-60"
